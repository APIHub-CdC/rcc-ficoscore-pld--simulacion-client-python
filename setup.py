...
NAME = "rcc-fico-pld-simulacion-client"
VERSION = "1.0.0"
...
setup(
    name=NAME,
    version=VERSION,
    description="Reporte de Crédito Consolidado, FICO® Score y PLD - Simulación",
    author_email="api@circulodecredito.com.mx",
    url="",
    keywords=["Swagger", "Reporte de Crédito Consolidado, FICO® Score y PLD - Simulación"],
